...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent transition-all duration-300">
      <motion.div 
      ...
      >
        <motion.div whileHover={{ scale: 1.05 }} className="flex items-center mb-6">
          <Sparkles className="mr-3 bg-gradient-to-r from-purple-500 via-violet-500 to-blue-500 bg-clip-text text-transparent" size={40} />
      ...
      <div className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center mb-8">
            <BookOpen className="mr-3 bg-gradient-to-r from-purple-500 via-violet-500 to-blue-500 bg-clip-text text-transparent" size={30} />
          ...
          {error ? (
            <p className="text-red-500 text-lg">Can't fetch data. Please try again later.</p>
          ) : roadmaps.length === 0 ? (
              ...
              {roadmaps.map((roadmap, index) => (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-2">
                    <strong>Created At:</strong> {new Date(roadmap.createdAt).toLocaleDateString()}
                  </p>

                  <p className="text-gray-500 mb-2">
                    <strong>Industry Trends:</strong> {roadmap.industryTrends}
                  </p>
